...
import { Check, Sun, Moon, Link2, X } from "lucide-react";
    ...
    if (ref) {
      ...
      fetch(`/api/referral/validate?code=${ref}`)
        ...
        .then((d) => {
          ...
          if (d.valid) setReferralName(d.referrerName);
        });
    }
  }, [searchParams]);
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-[#0f172a] dark:text-gray-100">{t.auth.registerTitle}</h1>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="mb-4 rounded-lg bg-blue-50 p-3 text-sm text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
            ...
            <div>
              ...
              {referralValid === true && (
                <p className="mt-1 flex items-center gap-1 text-xs text-emerald-600">
                  ...
                  Code valide — parrain: {referralName}
                </p>
              )}
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
          >
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          {t.auth.hasAccount}{" "}
          <Link href="/auth/login" className="font-medium text-[#7126b6] hover:underline">
            {t.auth.signIn}
          </Link>
        </p>
      </div>
